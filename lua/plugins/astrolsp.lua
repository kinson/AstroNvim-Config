...
return {
  ...
  opts = {
    ...
    config = {
      ...
      elixirls = {
        settings = { elixirLS = { dialyzerEnabled = false, fetchDeps = false, mixEnv = "test" } },
      },
      ...
      --   end
      --
      --   opts.settings = { workingDirectory = { mode = "location" } }
      --
      --   -- opts.root_dir = lspconfig.util.find_git_ancestor
      --
      --   return opts
      -- end,
    },
